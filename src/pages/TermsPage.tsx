        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-indigo-900/30 backdrop-blur-md border border-indigo-700/30 rounded-xl p-6 md:p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-xl font-semibold text-white mt-8 mb-4">第一条 服务概述</h2>
              ...
              <h2 className="text-xl font-semibold text-white mt-8 mb-4">第二条 注册与账户管理</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 className="text-xl font-semibold text-white mt-8 mb-4">第三条 用户行为规范</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 className="text-xl font-semibold text-white mt-8 mb-4">第四条 内容权利与义务</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 className="text-xl font-semibold text-white mt-8 mb-4">第五条 知识产权声明</h2>
              <div className="text-indigo-200 space-y-2">
                <p>5.1 本网站及其所有内容（包括但不限于文字、图像、软件代码、界面设计等）的知识产权归本公司所有。</p>
                <p>5.2 未经本公司书面许可，任何单位或个人不得擅自复制、修改、传播、展示、出租、出售本网站相关内容。</p>
              </div>

              <h2 className="text-xl font-semibold text-white mt-8 mb-4">第六条 服务终止与账户注销</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 className="text-xl font-semibold text-white mt-8 mb-4">第七条 责任限制</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 className="text-xl font-semibold text-white mt-8 mb-4">第八条 协议的修改</h2>
              <div className="text-indigo-200 space-y-2">
                <p>8.1 本公司有权根据业务发展或法律法规变化，修改本协议内容。</p>
                <p>8.2 修改后的协议将在本网站公告后生效，用户继续使用服务即视为接受新版本协议。</p>
              </div>

              <h2 className="text-xl font-semibold text-white mt-8 mb-4">第九条 争议解决</h2>
              <div className="text-indigo-200 space-y-2">
