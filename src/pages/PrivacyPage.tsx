        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-indigo-900/30 backdrop-blur-md border border-indigo-700/30 rounded-xl p-6 md:p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 id="data-collection-scope" className="text-xl font-semibold text-white mt-8 mb-4">第一条 信息收集范围</h2>
              ...
              <h2 id="data-usage-purpose" className="text-xl font-semibold text-white mt-8 mb-4">第二条 信息使用目的</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 id="data-storage-protection" className="text-xl font-semibold text-white mt-8 mb-4">第三条 数据存储与保护</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 id="data-sharing-disclosure" className="text-xl font-semibold text-white mt-8 mb-4">第四条 数据共享与披露</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 id="cookie-tracking" className="text-xl font-semibold text-white mt-8 mb-4">第五条 Cookie与追踪技术</h2>
              <div className="text-indigo-200 space-y-2">
                <p>5.1 我们使用Cookie、本地存储等技术来识别用户身份、记录偏好设置、提升用户体验。</p>
                <p>5.2 用户可以通过浏览器设置拒绝或管理Cookie，但这可能导致部分功能无法正常使用。</p>
              </div>

              <h2 id="user-rights" className="text-xl font-semibold text-white mt-8 mb-4">第六条 用户权利</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 id="minor-protection" className="text-xl font-semibold text-white mt-8 mb-4">第七条 未成年人保护</h2>
              <div className="text-indigo-200 space-y-2">
                <p>7.1 本网站不适合未满14周岁的儿童使用。</p>
                <p>7.2 如用户为未成年人，应在监护人指导下使用本网站，并取得监护人同意。</p>
              </div>

              <h2 id="privacy-policy-update" className="text-xl font-semibold text-white mt-8 mb-4">第八条 隐私政策的更新</h2>
              <div className="text-indigo-200 space-y-2">
                <p>8.1 我们可能根据法律法规变化或业务调整，更新本隐私政策。</p>
                <p>8.2 更新后的内容将在本网站公布即生效，请定期查阅最新版本。</p>
              </div>

              <h2 id="contact-us" className="text-xl font-semibold text-white mt-8 mb-4">第九条 联系我们</h2>
              <div className="text-indigo-200 space-y-2">
