        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-indigo-900/30 backdrop-blur-md border border-indigo-700/30 rounded-xl p-6 md:p-8">
            <div className="flex items-center justify-between mb-6">
              <h1 className="text-2xl md:text-3xl font-bold text-white">免责声明</h1>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 id="user-content-responsibility" className="text-xl font-semibold text-white mt-8 mb-4">一、用户上传内容的责任</h2>
              ...
              <h2 id="content-review-rights" className="text-xl font-semibold text-white mt-8 mb-4">二、内容审查与处理权利</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 id="intellectual-property" className="text-xl font-semibold text-white mt-8 mb-4">三、知识产权说明</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 id="data-security-privacy" className="text-xl font-semibold text-white mt-8 mb-4">四、数据安全与隐私保护</h2>
              <div className="text-indigo-200 space-y-2">
                <p>1.本公司高度重视用户的数据安全与隐私保护，相关数据仅用于AI分析服务，不会向第三方泄露，除非法律法规另有规定或用户明示同意。</p>
                <p>2.请参阅我们的《隐私政策》以了解我们如何收集、使用和保护您的个人信息。</p>
              </div>

              <h2 id="service-provision-disclaimer" className="text-xl font-semibold text-white mt-8 mb-4">五、服务的提供与免责</h2>
              <div className="text-indigo-200 space-y-2">
              ...
              <h2 id="third-party-links" className="text-xl font-semibold text-white mt-8 mb-4">六、链接与第三方内容</h2>
              <p className="text-indigo-200">
                本网站可能包含指向第三方网站的链接，这些链接仅供用户参考。本公司对这些网站的内容、隐私政策或服务不作任何担保或认可，也不承担任何责任。
              </p>

              <h2 id="disclaimer-modification" className="text-xl font-semibold text-white mt-8 mb-4">七、免责声明的修改</h2>
              <p className="text-indigo-200">
                本公司保留随时修改本免责声明的权利，修改后的内容将在本网站公布即生效。建议用户定期查阅最新版本的免责声明。
              </p>

              <h2 id="applicable-law-dispute" className="text-xl font-semibold text-white mt-8 mb-4">八、适用法律与争议解决</h2>
              <p className="text-indigo-200">
